...
- `2`：fail-closed——**无法从服务端拿到确定结果时一律 block**。命中场景：网络不可达 / 连接拒绝 / 读写超时 / TLS 失败 / 401 / 403 / 404 / 400 / 413 / 422 / 409 duplicate_id / 500 / 503 shutting_down / 协议反序列化失败 / 配置加载失败。不写 stdout JSON。
