...
> {
    ...
    match state
        .runtime
        .submit_pre_tool_use(trace, approval_id, payload, MAX_WAIT)
        .await
    {
...
pub(crate) fn map_runtime_error(
    ...
    let (status, code, message) = match e {
        ...
        | RuntimeError::NotFound(_) => (
            ...
            winvibe_core::error::APPROVAL_NOT_FOUND,
            "approval not found",
        ),
